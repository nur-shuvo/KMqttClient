...
import com.nurshuvo.kmqtt.internal.constants.SUBSCRIBE_REJECT_BY_BROKER_ERROR_CODE
import com.nurshuvo.kmqtt.internal.constants.SUBSCRIBE_REJECT_BY_BROKER_ERR_DESCRIPTION
...
class MqttSubscriptionHandlerImpl(
    ...
    override fun subscribe(
        ...
        val mqttCallbacks = clientComponent.mqttCallbacks
    ...
    override fun onSubAckReceived(
        ...
        scope.launch {
            ...
            if (this@MqttSubscriptionHandlerImpl::clientComponent.isInitialized.not()) {
                return@launch
            }
            val mqttCallbacks = clientComponent.mqttCallbacks
            if (isSuccess) {
    ...
    private fun reSubscribeAll() {
        if (this@MqttSubscriptionHandlerImpl::clientComponent.isInitialized.not() ||
            this@MqttSubscriptionHandlerImpl::clientIdentifier.isInitialized.not()
        ) {
            return
        }
        val nativeClient = clientComponent.clientComponent
